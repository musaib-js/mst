...
from courses.models import Course , Video , Payment , UserCourse, video
from django.shortcuts import HttpResponse
# Create your views here.
from django.views.decorators.csrf import csrf_exempt
from django.contrib.auth.decorators import login_required
from mirchalsirstutorials.settings import *
from time import time

import razorpay
client = razorpay.Client(auth=('rzp_live_ZsFxLj7hoMk3Xv', 'd8doxHvHbQRmBk0EeX5nljc7'))
